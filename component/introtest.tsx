...
export default function Intro() {
    ...
    useLayoutEffect(() => {
        if (imageRef1.current && imageRef2.current && imageRef3.current && imageRef4.current && divRef1.current && divRef2.current && divMainRef.current) {
            ...
            // Hide main container and trigger flip
    ...
    return (
        <div className="relative flex items-center justify-center min-h-screen w-full overflow-hidden" style={{ perspective: '1000px' }}>
                    ...
                    >
                        ...
                        >
                            <div className='flex flex-col items-center justify-center '>
                                <img src="/logo/fav-top.png" alt="" width={30} height={30} style={{ transform: 'translate(-10px, 105px) scale(1)' }} />
                                <img
                                    src="/logo/fav-center.png"
                                    alt=""
                                    width={800}
                                ...
                                />
                                <img src="/logo/fav-bottom.png" alt="" width={52} height={20} style={{ transform: 'translate(6px, -104px) scale(1)' }} />
                            </div>
